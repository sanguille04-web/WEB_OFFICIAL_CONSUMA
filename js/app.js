...
function extraMedallonPrice(name,cat){
 ...
 if(n.includes("gigante")||n.includes("pizza burger")||n.includes("xl")||n.includes("doble"))return 2500;
 return 2000;
}
...
nav();render();ensureQuickNav();count();tick();setInterval(tick,15000);
