...
const PROMO_DRINKS=[
 ...
 {name:"Coca-Cola 1,5 L",price:3500},
 {name:"Fanta 1,5 L",price:3500},
 {name:"Sprite 1,5 L",price:3500}
];
const COMBO_DRINKS=[
...
function openModifier(name,price,cat){
 ...
 const sauces=comboMode?COMBO_DRINKS:(promoMode?PROMO_DRINKS:(cat==="Hamburguesas"?BURGER_SAUCES:STANDARD_SAUCES));
