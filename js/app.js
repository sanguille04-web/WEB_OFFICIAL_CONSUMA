...
function toggleSauce(input){
 ...
 if(input.value==="Sin aderezo"&&input.checked){
   inputs.forEach(item=>{if(item!==input)item.checked=false});
 }else if(input.checked){
   const none=inputs.find(item=>item.value==="Sin aderezo");
